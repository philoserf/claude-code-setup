...
**Working Directory**: All scripts must be run from the skill directory:

```bash
cd /Users/markayers/.claude/skills/process-pdfs
```

Or use absolute paths: `python /Users/markayers/.claude/skills/process-pdfs/scripts/script_name.py`

If you need to fill out a PDF form, first check to see if the PDF has fillable form fields. Run this script:
